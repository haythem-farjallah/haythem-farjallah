...
Two years of professional experience delivering backend changes to production with Spring Boot,
Drupal and Node.js, shipped through a five-environment promotion process with peer review, QA
...
Two-node cluster built from scratch with kubeadm and Cilium, running Gateway API. I wrote
fault-injection scripts that snapshot both nodes and introduce an unknown failure, so I can
practise blind, timed recovery — kubelet failures, expired certificates, disk pressure,
misconfigured container-runtime sockets. Also covers cluster upgrades, etcd backup and restore,
RBAC, Helm and Kustomize.

---

### Tools

Kubernetes · kubeadm · Cilium · Docker · Linux · Go · Bash · Java / Spring Boot · Jenkins ·
...
[LinkedIn](https://www.linkedin.com/in/haythem-farjallah-a46737221) · [haythem.farjallah4@gmail.com](mailto:haythem.farjallah4@gmail.com)
